...
public class OTPEditText extends AppCompatEditText {
    ...
    protected float mSpace = 35; //24 dp by default, space between the lines
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int colorFocused = isInEditMode() ? Color.WHITE : ContextCompat.getColor(context, R.color.white);
        mColors[1] = colorFocused;

        int colorUnfocused = isInEditMode() ? Color.WHITE : ContextCompat.getColor(context, R.color.white);
...
//            TraceUtils.logE("mCharSize<0",""+mCharSize);
        } else {
